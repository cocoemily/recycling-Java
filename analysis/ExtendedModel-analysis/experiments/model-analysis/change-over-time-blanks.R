...
mplot = ggplot() +
  ...
  scale_x_reverse() +
  scale_color_colorblind() +
  labs(color = "mu parameter", x = "model year", y = "average number of blanks produced")

ggsave(filename = "blanks-trend-by-mu.png", mplot, dpi = 300)
...
splot = ggplot() +
  ...
  scale_x_reverse() +
  scale_color_colorblind() +
  labs(color = "flake preference", x = "model year", y = "average number of blanks produced")
