...
descdist(alldata$total.RI, discrete=F)

plotNormalHistogram(alldata$total.CR)
descdist(alldata$total.CR, discrete=F)

plotNormalHistogram(alldata$num.scav.events)
descdist(alldata$num.scav.events, discrete=F)

plotNormalHistogram(alldata$total.recycled)
descdist(alldata$total.recycled, discrete=F)

plotNormalHistogram(alldata$num.deposits)
descdist(alldata$num.deposits, discrete=F)

plotNormalHistogram(alldata$total.encounters)
descdist(alldata$total.encounters, discrete=F)

plotNormalHistogram(alldata$total.discards)
descdist(alldata$total.discards, discrete=F)

plotNormalHistogram(alldata$total.manu.events)
descdist(alldata$total.manu.events, discrete=F)
