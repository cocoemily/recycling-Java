...
output_table = function(parameter) {
  return(
...
output_table(parameters[1])
output_table(parameters[2])
output_table(parameters[3])
output_table(parameters[4])
output_table(parameters[5])
output_table(parameters[6])
output_table(parameters[7])
output_table(parameters[8])
output_table(parameters[9])
output_table(parameters[10])
output_table(parameters[11])
output_table(parameters[12])
output_table(parameters[13])
