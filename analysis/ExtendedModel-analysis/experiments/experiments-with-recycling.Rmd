...
#descdist(alldata$total.RI, discrete=F, boot=20)

plotNormalHistogram(alldata$total.CR)
#descdist(alldata$total.CR, discrete=F, boot=20)

plotNormalHistogram(alldata$num.scav.events)
#descdist(alldata$num.scav.events, discrete=F, boot=20)

plotNormalHistogram(alldata$total.recycled)
#descdist(alldata$total.recycled, discrete=F, boot=20)

plotNormalHistogram(alldata$num.deposits)
#descdist(alldata$num.deposits, discrete=F, boot=20)

plotNormalHistogram(alldata$total.encounters)
#descdist(alldata$total.encounters, discrete=F, boot=20)

plotNormalHistogram(alldata$total.discards)
#descdist(alldata$total.discards, discrete=F, boot=20)

plotNormalHistogram(alldata$total.manu.events)
#descdist(alldata$total.manu.events, discrete=F, boot=20)

plotNormalHistogram(alldata$total.retouches)
#descdist(alldata$total.retouches, discrete=F, boot=20)
...
# gg_miss_fct(facet_data, fct = as.factor(facet_data$overlap))
