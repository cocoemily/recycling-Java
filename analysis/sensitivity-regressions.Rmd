...
lrtest(breg_msns, betareg(s.total.RI ~ model_year, data = u_alldata))
...
lrtest(breg_msfs, betareg(s.total.RI ~ model_year, data = u_alldata))
coeftest(breg_msfs, vcov = vcovBS(breg_msfs, R=25))

breg_ss = betareg(s.total.RI ~ model_year + strict_selection, data = u_alldata)
lrtest(breg_ss, betareg(s.total.RI ~ model_year, data = u_alldata))
