...
summary(aov(total.RI ~ size_preference*strict_selection*model_year, data=alldata))

summary(aov(total.RI ~ flake_preference*strict_selection*model_year, data=alldata))
