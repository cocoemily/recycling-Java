...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		Model model = new Model("test", 6, 250000, 100, 30, 10, 10, 0.5, 2, 0);
		model.print();
		
		model.createRandomSources(0.25, 30, 1);
		...
		//model.createAgents(0, model.totalAgents); //create all same agents for testing
